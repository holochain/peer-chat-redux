module.exports = scenario => {
  ...
  scenario('Agent 2 requests first_name from Agent 1', async (s, t, {chat_instance_1, personas_instance_1, chat_instance_2}) => {
    ...
    await personas_instance_1.callSync("personas", "add_field", {persona_address: persona_address, field: {name: "first_name", data: "Philip"}})
    ...
    const get_persona_field = await personas_instance_1.callSync("personas", "get_field", {persona_address: persona_address, field_name: "first_name"})
    console.log(get_persona_field)

    const get_first_name_received = await chat_instance_2.call('chat', 'get_first_name', {agent_address: chat_instance_1.agentId})
    console.log('get_first_name_received', get_first_name_received.Ok)

    t.deepEqual(get_first_name_received.Ok.body, 'Philip')
